function buildGtmBootstrapScript(gtmId) {
...
function buildGaBootstrapScript(gaMeasurementId) {
    return `window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag('js', new Date());gtag('config', '${gaMeasurementId}', {page_title: document.title,send_page_view: true,});`;
}

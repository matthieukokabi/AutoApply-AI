...
- [ ] Verify first terminal scheduled execution after workflow version `f8aa332c-4278-4555-892b-7a1303f6ca27` and confirm `Fetch & Normalize All Job Sources` returns items (`itemCount > 0`) for active paid users

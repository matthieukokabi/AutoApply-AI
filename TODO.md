...
- [ ] Verify first terminal scheduled execution after workflow version `733ff959-c2ee-4b04-ae52-b7e5edf3b19f` and confirm `Fetch & Normalize All Job Sources` returns items (`itemCount > 0`) for active paid users

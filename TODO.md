...
- [ ] Standardize GA4 events: `sign_up_started`, `sign_up_completed`, `begin_checkout`, `purchase`, `onboarding_completed`, `cv_uploaded` (in progress: `begin_checkout` + `sign_up_started` wired on 2026-03-17)

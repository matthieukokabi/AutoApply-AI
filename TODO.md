...
- [ ] Verify first terminal scheduled execution after workflow version `c0bcac6c-7bf6-4311-9a3c-81e180faa3b0` and confirm non-zero discovery output path (`Fetch Jobs via App API` + `Fetch & Normalize All Job Sources` itemCount > 0) for active paid users

...
- [ ] Write description (from social-media-kit.md)
- [ ] Upload 3-5 screenshots (dashboard, job feed, CV viewer, mobile)
- [ ] Select topics: AI, SaaS, Hiring and Recruiting, Resumes, Productivity
- [ ] Set URL: https://autoapply.works
- [ ] Schedule launch for a Tuesday or Wednesday (best PH days)
- [ ] Prepare first comment (from social-media-kit.md)
...
- [ ] Indie Hackers — https://www.indiehackers.com/product (create product page)
- [ ] Hacker News — "Show HN: AutoApply AI" post
- [ ] Reddit — r/jobsearchhacks, r/resumes, r/SideProject posts
- [ ] Dev.to — Technical blog post about the architecture
- [ ] Create demo video (30-60s) for Product Hunt + social
